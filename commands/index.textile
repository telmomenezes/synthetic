...
{% highlight bash %}
$ synt evo -inet <network1> -inet2 <network2>
{% endhighlight %}
...
Computes fitness of a set of programs.

{% highlight bash %}
$ synt compfit -inet <network> -dir <dir> -out <csv_file>
{% endhighlight %}
...
{% highlight bash %}
$ synt gen -inet <network> -prg <generator> -onet <network>
{% endhighlight %}
...
{% highlight bash %}
$ synt run -inet <network> -odir <dir>
{% endhighlight %}
